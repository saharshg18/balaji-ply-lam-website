...
function Professionals() {
  return (
    <section className="professionals-section" aria-labelledby="professionals-title">
      <div className="professionals-copy"><Reveal><Eyebrow>For architects &amp; interior designers</Eyebrow><h2 id="professionals-title">Your vision.<br /><em>Our materials.</em></h2><p>A reliable material destination for design professionals. Explore textures, compare finishes and bring your palette together with multiple material categories in one convenient Kolkata address.</p><p className="professionals-invitation">Bring your ideas. Let's explore the possibilities.</p><div className="button-group"><ContactLink kind="whatsapp" message={messages.professional} variant="light">Let's Talk Materials</ContactLink><ContactLink kind="call" variant="outline-light" /></div></Reveal></div>
