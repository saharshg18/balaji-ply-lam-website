      ...
      <div className="container">
        <div className="footer-top">
          <div className="footer-brand">
            <Logo />
            <p>Considered materials.<br />Beautiful possibilities.</p>
            <span>Plywood, laminates &amp; interior materials in Kolkata.</span>
          </div>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Balaji Ply &amp; Lam. All rights reserved.</p>
